...
$(window).load(function() {
	/*I added this in afterwards for page fadeIn*/
...
/*I added for page fade out*/
/*Note: The page fades In with body class set to the fadeIn class in the html and using css keyframes*/

function fadeOutExit(){

    $( "body" ).addClass("fadeOut_0d5s");
...
//using javascript change display: none to display: block to initialize the picture after page load
$( document ).ready(function() {
  $(".fp_preview").delay(2000).fadeIn(3000);
});
...
$(".return a").click(function(e) {
    ...
    setTimeout(
        function(){
            window.location.href = "../../index.html#passions";                
        }, 500
    );
});
...
$(".reference a").click(function(e) {
    ...
    setTimeout(
        function(){
            window.location.href = "http://tympanus.net/codrops/author/crnacura/";                
        }, 500
    );    
});
